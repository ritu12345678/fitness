...
const DeleteRequestFilter = ({ onFilterChange, refreshDeleteRequests }) => {
  ...
  React.useEffect(() => {
    console.log('🔍 DeleteRequestFilter - filters changed:', filters);
    onFilterChange?.(filters);
  }, [filters, onFilterChange]);

  const handleExport = () => {
    console.log('Export delete requests');
  };
